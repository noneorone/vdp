...
public class CardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(mContext).load(mCardList.get(position).getImages().get(0)).centerCrop().crossFade().diskCacheStrategy(DiskCacheStrategy.RESULT).into(holder.mCardImageView);
