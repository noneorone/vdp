package com.noo.core.widget.marquee;
...
public class FlipperView extends LinearLayout {
    ...
    public void initBasicView(AttributeSet attrs) {
        ...
        viewFlipper = flipperTextView.findViewById(R.id.vf_container);
        viewFlipper.setInAnimation(AnimationUtils.loadAnimation(mContext, R.anim.widget_flipper_slide_in_bottom));
        viewFlipper.setOutAnimation(AnimationUtils.loadAnimation(mContext, R.anim.widget_flipper_slide_out_top));
        viewFlipper.startFlipping();
        viewFlipper.setBackgroundColor(flipBackgroundColor);
        viewFlipper.setFlipInterval(flipInterval);

        if (deletable) {
            ImageView iv = flipperTextView.findViewById(R.id.iv_delete);
