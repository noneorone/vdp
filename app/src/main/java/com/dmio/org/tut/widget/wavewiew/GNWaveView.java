...
public class GNWaveView extends View {
    /**
     * +------------------------+
     * |<--wave length->        |______
     * |   /\          |   /\   |  |
    ...
    public GNWaveView(Context context) {
        super(context);
        init();
    }

    public GNWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GNWaveView(Context context, AttributeSet attrs, int defStyle) {
